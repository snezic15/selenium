...
public class CaseType_Runner extends JFrame implements ActionListener {
	...
	public CaseType_Runner() {
		...
		l6 = new JLabel("Case Status");
		l6.setBounds(20, 300, 100, 30);
		frame.getContentPane().add(l6);

		String[] CaseStatus = { "Pending", "Disposed" };
		c5 = new JComboBox(CaseStatus);
		c5.setBounds(180, 300, 100, 30);
	...
	ActionListener submit = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (o == b1) {
				...
				String caseStatus = c5.getSelectedItem().toString();
				...
				try {
					Fd.testCaseType(caseCode, data, casetype, yr, caseStatus, NoofRecord);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
			}
